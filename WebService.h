...
#define API_ARRAY @[EVENT_API_ARRAY, EVENT_API_SINGLE_ARRAY, EVENT_API_JOIN_ARRAY, LOGIN_API_PARAMS_ARRAY, EVENT_API_CREATE_ARRAY, USER_API_SINGLE_PARAMS_ARRAY]
